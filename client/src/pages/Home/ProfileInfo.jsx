            ...
            <div className="flex flex-col items-center">
               ...
               {/* <img src="https://randomuser.me/api/portraits/men/94.jpg" class="w-32 h-32 bg-gray-300 rounded-full mb-4 shrink-0">
                ...
                >
                  ...
                  <h2 className="text-xl font-bold mt-6 mb-4">Experiencia</h2>

                    <div className="mb-6">
                      <div className="flex justify-between flex-wrap gap-2 w-full">

                       <span className="text-gray-700 font-bold">Desarrollador Web</span>
                            <p>
                                <span className="text-gray-700 mr-2">ABC Company</span>
