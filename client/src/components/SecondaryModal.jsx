...
const SecondaryModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/40 bg-black/40 backdrop-blur-sm p-4">
    <div className={`relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden animate-fadeIn`}>
