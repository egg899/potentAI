...
const SecondaryModal = ({
  ...
  return (
    <div
      className="fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black/40 backdrop-blur-sm"
      style={{ zIndex }}
      onClick={onClose}
    >
      <div
        className="relative flex flex-col bg-white shadow-lg rounded-lg overflow-hidden animate-fadeIn max-h-[90vh] w-full max-w-lg"
        ...
        {showActionBtn && (
          <div className="p-4 border-t border-gray-200 flex justify-end">
            <button
              ...
              className="inline-flex items-center gap-2 px-4 py-2 rounded-lg bg-[#32baa5] text-white hover:bg-[#32baa5]/90"
            >
              {actionBtnIcon}
              {actionBtnText}
            </button>
